...
function CreateGigs() {
  ...
  const addGig = async () => {
    ...
    if (shortDesc.length === 0) missingFields.push("Short Description");
    if (revisions <= 0) missingFields.push("Revisions");
    if (time <= 0) missingFields.push("Delivery Time");
    ...
    <div className="min-h-[80vh] my-10 mt-0 px-32">
      ...
      <form className="flex flex-col gap-5 mt-10">
        <div className="grid grid-cols-2 gap-11">
          ...
          <div>
            <label htmlFor="categories" className={labelClassName}>Select a Category</label>
            <select
              id="categories"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4"
              name="category"
              onChange={handleChange}
              value={data.category} // Make sure it's controlled
            >
        ...
        <div className="grid grid-cols-2 gap-11">
          <div>
            <label htmlFor="delivery" className={labelClassName}>Delivery Time (Months)</label>
            <input
              type="number"
              className={inputClassName}
              id="delivery"
          ...
          <div>
            <label htmlFor="revision" className={labelClassName}>Revisions (Updates)</label>
            <input
              type="number"
              id="revision"
              className={inputClassName}
        ...
        <div className="grid grid-cols-2 gap-11">
          <div>
            <label htmlFor="features" className={labelClassName}>Features</label>
          ...
          <div>
            <label htmlFor="image" className={labelClassName}>Gig Images (optional)</label>
            <div>
